...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/isn/{isn_slug}/signal_types/{signal_type_slug}/signals/{signal_id}": {
            "get": {
                "tags": [
                    "Signal sharing"
                ],
