        ...
        "/api/isn/{isn_slug}/signal_types/{signal_type_slug}/v{sem_ver}/signals": {
            "post": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Forbidden (insufficient permissions, error_code = forbidden)",
                        "schema": {
                            "$ref": "#/definitions/responses.ErrorResponse"
                        }
                    },
