...
// or user permissions.
func (h *HandlerService) APISignalTypeSlugs(w http.ResponseWriter, r *http.Request) {
...
func (h *HandlerService) APISignalTypeVersions(w http.ResponseWriter, r *http.Request) {
	reqLogger := logger.ContextRequestLogger(r.Context())
...
func (h *HandlerService) TokenSignalTypeSlugs(w http.ResponseWriter, r *http.Request) {
	reqLogger := logger.ContextRequestLogger(r.Context())
...
func (h *HandlerService) TokenSignalTypeVersions(w http.ResponseWriter, r *http.Request) {
	reqLogger := logger.ContextRequestLogger(r.Context())
